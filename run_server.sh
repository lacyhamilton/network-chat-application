...
RUN_GCC="gcc -Wall src/server/main.c src/server/client_handler.c src/server/client_list.c src/network.c src/message.c src/chat_node.c src/properties.c -o $EXECUTABLE -lpthread" 
